...
i=1
print(i)
path = '/home/anusha/Desktop/Data/Training/GB/Fake/'
path2 = '/home/anusha/Desktop/Wavelet_data/Training/Fake/'
...
for folder in dirlist:
    ...
    for file in dirlist:
        ...
        im1 = sp.misc.imread(os.path.join(path1, file))
        im = im1[:,:,0]
        print im
        ext='.png'
        name = str(i) + ext
        ...
        output_file_name = os.path.join(path2,"ExtractGB" +name)
